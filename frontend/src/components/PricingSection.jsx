    ...
    return (
        <section className="w-full rounded-xl p-[20px]">
            <h1 className="text-[30px] font-[500] leading-[40px] text-center">The Right Plan for
                Your Business</h1>
            <p className="text-[18px] font-[400] text-gray-400 w-full sm:w-[50%] text-center mx-auto mt-2">We
            ...
            <div className="w-full flex-col sm:flex-row flex items-center justify-center mt-8 gap-[20px]">
                ...
                >
                    <div
                        className={`${
                            isMonthly ? " translate-x-[27px]" : "translate-x-[0px]"
            ...
            <div
                ...
                <div
                    className="w-full flex flex-col max-w-[280px] justify-between h-full bg-white rounded-xl p-[20px]">
                    <div>
