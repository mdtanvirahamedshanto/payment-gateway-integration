...
const Signin = () => {
  ...
  return (
    <main className="w-full h-auto sm:h-[100vh] bg-gray-200 flex items-center justify-center sm:p-0 p-6">
      <form className="w-full sm:w-[40%] bg-white rounded-lg sm:py-6 sm:px-8 p-4 flex items-center justify-center flex-col gap-5">
        ...
        <div className="flex items-center justify-center w-full gap-1">
          ...
          <span>
            <Link to={"/register"} className="text-[1rem] text-blue-500 font-[500]">
              Signup
            </Link>
          </span>
        </div>
